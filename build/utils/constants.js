...
var FIND_DETAIL_POST = "SELECT Content FROM Articles WHERE Id='IdValue'";
var GET_FULL_DETAIL_POST = "SELECT * FROM Articles WHERE Id='IdValue'";
var FIND_ALL_TOPIC = 'SELECT Topic FROM Articles';
...
var INSERT_AUDIO = "INSERT INTO Audio (id,parent,videoId) VALUES ('idValue','parentValue','videoIdValue')";
...
module.exports = {
    ...
    FIND_DETAIL_POST: FIND_DETAIL_POST,
    GET_FULL_DETAIL_POST: GET_FULL_DETAIL_POST,
    FIND_ALL_TOPIC: FIND_ALL_TOPIC,
