...
exports.getAllPost = exports.getFeaturedPosts = exports.getMainPosts = void 0;
var any = require('express').query;
...
var GET_MAIN_ARTICLE = constants_1.default.GET_MAIN_ARTICLE, GET_FEATURED_ARTICLE = constants_1.default.GET_FEATURED_ARTICLE, GET_ARTICLE_AS_PAGE = constants_1.default.GET_ARTICLE_AS_PAGE, COUNT_TOTAL_ARTICLE = constants_1.default.COUNT_TOTAL_ARTICLE, FIND_DETAIL_POST = constants_1.default.FIND_DETAIL_POST, GET_FULL_DETAIL_POST = constants_1.default.GET_FULL_DETAIL_POST, FIND_ALL_TOPIC = constants_1.default.FIND_ALL_TOPIC, FIND_ARTICLE_AS_TOPIC = constants_1.default.FIND_ARTICLE_AS_TOPIC, SEARCH_ARTICLES = constants_1.default.SEARCH_ARTICLES, FIND_ARTICLES_BELONG_IN_LIST_ID = constants_1.default.FIND_ARTICLES_BELONG_IN_LIST_ID, ERROR_CODE = constants_1.default.ERROR_CODE;
...
var getAllPost = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var response, _a, pageIndex, _b, orderType, orderBy, headArticle, found, start, pageSize, executeQuery;
    return __generator(this, function (_c) {
        response = new response_params_1.RepsonseAllPost([], 0, false);
        _a = req.body, pageIndex = _a.paging.pageIndex, _b = _a.orderList, orderType = _b.orderType, orderBy = _b.orderBy, headArticle = _a.headArticle, found = _a.found;
        start = null;
        ...
        executeQuery = new Promise(function (resolve, reject) {
            ...
            request.query(COUNT_TOTAL_ARTICLE, function (err, data) {
                ...
                request.query(GET_ARTICLE_AS_PAGE.replace('orderByValue', orderBy)
                    ...
                    .replace('pageSizeValue', pageSize.toString()), function (err, data) { return __awaiter(void 0, void 0, void 0, function () {
